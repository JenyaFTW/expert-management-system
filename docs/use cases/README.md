...
@startuml
    left header
        ...
        <font color=000 size=16><b>Передумови:</b> Авторизація, Отримання запрошення на участь в опитуванні
...
@startuml
    ...
    left header
        ...
        <font color=000 size=16><b>Передумови:</b> Авторизація, Існує список опитування
...
@startuml
    ...
    left header
        ...
        <font color=000 size=16><b>Передумови:</b> Авторизація, Замовник увійшов до системи опитування
...
@startuml
    ...
    left header
        ...
        <font color=000 size=16><b>Учасники:</b> Замовник, Система
        <font color=000 size=16><b>Передумови:</b> Авторизація, Існує звітність
...
@startuml
    ...
    left header
        ...
        <font color=000 size=16><b>Передумови:</b> Авторизація, Аналітик натискає кнопку для створення опитування
...
@startuml
    ...
    left header
        ...
        <font color=000 size=16><b>Учасники:</b> Аналітик, система опитування
        <font color=000 size=16><b>Передумови:</b> Авторизація, Опитування
...
@startuml
    ...
    left header
        ...
        <font color=000 size=16><b>Учасники:</b> Аналітик, система опитування
        <font color=000 size=16><b>Передумови:</b> Авторизація, Наявність опитування
...
@startuml
    ...
    left header
        ...
        <font color=000 size=16><b>Учасники:</b> Аналітик, Система
        <font color=000 size=16><b>Передумови:</b> Авторизація, Наявність запиту на додавання/видалення нового експерта
...
@startuml
    ...
    left header
        ...
        <font color=000 size=16><b>Учасники:</b> Аналітик, Система
        <font color=000 size=16><b>Передумови:</b> Авторизація, Наявність результатів опитування
